...
const HourlyRates = () => {
    ...
    useEffect(() => {
        const fetchHourlyRate = async () => {
            ...
            try {
                ...
                const response = await axios.get('http://localhost:4000/api/v1/user/getUserDetails'); // Adjust the endpoint as necessary
    ...
    const updateRate = async () => {
        ...
        try {
            axios.defaults.withCredentials = true;
            await axios.put('http://localhost:4000/api/v1/user/updateHourlyRate', { hourlyRate: newRate }); // Adjust the endpoint as necessary
