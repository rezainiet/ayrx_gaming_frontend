...
const BookingManagement = () => {
    ...
    useEffect(() => {
        const fetchBookings = async () => {
            try {
                ...
                const response = await axios.get(`${import.meta.env.VITE_API_URI}/api/v1/booking/getBookings/${userId}`);
    ...
    const handleSave = async (values) => {
        try {
            ...
            await axios.put(`${import.meta.env.VITE_API_URI}/api/v1/booking/updateBooking/${currentBooking._id}`, values);
    ...
    const handleAccept = async (booking) => {
        try {
            ...
            await axios.put(`${import.meta.env.VITE_API_URI}/api/v1/booking/updateBookingConfirm/${booking._id}`, payload);
